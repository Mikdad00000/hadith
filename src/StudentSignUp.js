...
function SInput({ label, type, ph, value, fn }) {
        return (
                <div>
...
const StudentSignUp = () => {
        ...
        const Submit = () => {
                ...
                fetch("http://localhost:3001/studentsignup", {
                        method: "POST", // or 'PUT'
                        headers: {
                ...
                }).then((response) => window.alert("Data is uploded"));
                setFirst("");
                setLast("");
                setMobile("");
                setEmail("");
                                                ...
                                                <div className="w-full">
                                                        ...
                                                        <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                                                                <SInput
                                                                        ...
                                                                        ph="Abdur"
                                                                        value={first}
                                                                        fn={(e) => setFirst(e.target.value)}
                                                                />
                                                                <SInput
                                                                        label="Last Name"
                                                                        ph="Rahman"
                                                                        value={last}
                                                                        fn={(e) => setLast(e.target.value)}
                                                                />
                                                                <SInput
                                                                        label="Phone Number"
                                                                        ph="XXX-XX-XXX-XXX"
                                                                        value={mobile}
                                                                        fn={(e) => setMobile(e.target.value)}
                                                                />
                                                                <SInput
                                                                        label="Email Address"
